...
/*   Updated: 2025/05/26 15:00:38 by bleow            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//     // New debug print - function entry
...
//     // New debug print - found command
//     fprintf(stderr, "DEBUG-EXEC-REDIR: Found command node: '%s'\n",
...
//         reset_redirect_fds(vars);
//         reset_terminal_after_heredoc();
//         // NEW: Return proper error code (1 if error_code is 0, otherwise use error_code)
